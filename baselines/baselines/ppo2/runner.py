...
class Runner(AbstractEnvRunner):
    ...
    - Make a mini batch
    """
    def __init__(self, *, env, model, nsteps, gamma, lam, population=None, ent_pool_coef=0.0, ent_version=3,
                 history_len=10, div_version=0):
                ...
                if self.population is not None:
                    ...
                    if self.ent_version == 3:
                        ...
                        if self.div_version == 0:
                            ...
                            rewards_np = rewards_np + self.ent_pool_coef * (
                                        entropy_pop_new - np.mean(agent_entropy, axis=0) / (
                                            pop_len + 1))
                        else:

...
def my_config():
    ...
    # num_exp-th independent repetition of the experiment
    NUM_EXP = 0
    ...
    # if TIMESTAMP_DIR:
    #     SAVE_DIR = PBT_DATA_DIR + time.strftime('%Y_%m_%d-%H_%M_%S_') + EX_NAME + '_priority'+ str(PRIORITIZED_SAMPLING) + "/"
    # else:
    #     SAVE_DIR = PBT_DATA_DIR + EX_NAME + '_div'+ str(DIV_VERSION) + '_entloss' + str(ADD_ENT_TO_LOSS) + "/"
    ...
    TOTAL_STEPS_PER_AGENT = 1.1e7 if not LOCAL_TESTING else 1e4
    ...
    NUM_SELECTION_GAMES = 6 if not LOCAL_TESTING else 2
    ...
    LOAD_FOLDER_LST = f' :' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_1000/agent{NUM_EXP}/pbt_iter1/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_1000/agent{NUM_EXP}/pbt_iter137/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_1000/agent{NUM_EXP}/best/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_2000/agent{NUM_EXP}/pbt_iter1/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_2000/agent{NUM_EXP}/pbt_iter137/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_2000/agent{NUM_EXP}/best/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_3000/agent{NUM_EXP}/pbt_iter1/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_3000/agent{NUM_EXP}/pbt_iter137/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_3000/agent{NUM_EXP}/best/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_4000/agent{NUM_EXP}/pbt_iter1/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_4000/agent{NUM_EXP}/pbt_iter137/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_4000/agent{NUM_EXP}/best/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_5000/agent{NUM_EXP}/pbt_iter1/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_5000/agent{NUM_EXP}/pbt_iter137/:' \
                      f'/home/wujl/wangyt/humanai/human_aware_rl/pbt/FCP/{EX_NAME}/seed_5000/agent{NUM_EXP}/best/'
    ...
    def pbt_training():
        ...
        for pbt_iter in range(1, params["NUM_PBT_ITER"] + 1):
            ...
            for k in range(population_size):
                logz.log_tabular(f"Partner{k}SparseReward", format(np.mean(avg_ep_returns_sparse_dict[0][k]), '.5f'))
            logz.log_tabular("MinSparseReward",
                             format(np.min(
                                 [np.mean(avg_ep_returns_sparse_dict[0][k]) for k in range(population_size)]),
                                    '.5f'))
            logz.log_tabular("MaxSparseReward",
                             format(np.max(
                                 [np.mean(avg_ep_returns_sparse_dict[0][k]) for k in range(population_size)]),
                                    '.5f'))
            logz.log_tabular("AverageSparseReward",
                             format(np.mean(
                                 [np.mean(avg_ep_returns_sparse_dict[0][k]) for k in range(population_size)]),
                                    '.5f'))
            logz.log_tabular("StdSparseReward",
                             format(np.std(
                                 [np.mean(avg_ep_returns_sparse_dict[0][k]) for k in range(population_size)]),
                                    '.5f'))
            logz.dump_tabular()
...
def run_pbt(params):
    create_dir_if_not_exists(params["SAVE_DIR"])
    save_dict_to_file(params, params["SAVE_DIR"] + "config")
    set_global_seed(params["SEEDS"])
    curr_seed_params = params.copy()
    curr_seed_params["SAVE_DIR"] += "seed_{}/".format(params["SEEDS"])
    pbt_one_run(curr_seed_params, params["SEEDS"])
